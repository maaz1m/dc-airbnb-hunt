...
```{r}
#anova test to compare mean price
anovaRes_price <-  aov(price ~ room_type, data=means_df_rt)
xkabledply(anovaRes_price, title = "Price ANOVA")

#anova test to compare mean rating
anovaRes_rating <-  aov(review_scores_rating ~ room_type, data=means_df_rt)
xkabledply(anovaRes_rating, title = "Rating ANOVA")
```
