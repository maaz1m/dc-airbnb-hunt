...
anovaRes_rating1 <-  aov(review_scores_rating ~  neighbourhood, data=df)
...
anovaRes_price2 <-  aov(price ~ room_type, data=df_175)
xkabledply(anovaRes_price2, title = "Price by Room Type ANOVA")
#anova test to compare mean rating
anovaRes_rating2 <-  aov(review_scores_rating ~ room_type, data=df_175)
