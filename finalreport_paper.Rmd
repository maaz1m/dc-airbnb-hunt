...
We attempt to create a predictive model for price using the features available. For this we use classical approaches such as linear regression, k-nearest neighbors, regression tree and random forest.
